...
class GlobalPlanner:
    ...
    def replan(self,req):
        ...
        self.plan_rx,self.plan_ry = self.planner.planning(self.plan_ox, self.plan_oy, self.plan_sx,self.plan_sy,self.plan_gx,self.plan_gy, -10, -10, 10, 10)
    ...
    def initPlanner(self):
        ...
        self.planner = AStarPlanner(1,0.6)
